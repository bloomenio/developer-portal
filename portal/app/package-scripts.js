  ...
  scripts: {
    ...
    start: {
      ...
      web: {
        ...
        devel: {
          ...
          script: series(
            'nps banner.serve',
            'nps "ng.serve --proxy-config proxy.conf.js --open --port=4202 --disable-host-check"'
          )
        },
        pre: {
    ...
    build: {
      ...
      web: {
        ...
        prod: series(
          'nps env',
          'nps "ng.build --base-href=/dev-portal/ --prod"'
        ),
        docker: series(
          'nps env',
          'nps "ng.build --configuration=docker --base-href=/dev-portal/ --prod"'
        )
        }
    },
