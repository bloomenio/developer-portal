...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  public notifierGlobal$: Subscription;
  ...
  public ngOnInit() {
    ...
    this.notifierGlobal$ = this.notificationService.getSubscription(ERROR_CONTEXTS.GLOBAL, (error) => this.error = error );
  ...
  public ngOnDestroy() {
    ...
    this.notifierGlobal$.unsubscribe();
  }
